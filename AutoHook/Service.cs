...
public class Service {
    ...
    // porting-note(api13): kept from this build - CS 6966 has no CurrentCastBaitFlags,
    // so WorldStateUpdater reads mooch state through this instead.
    public static SeFunctions.BaitManager BaitManager { get; set; } = null!;
    ...
    public static async ValueTask InitAsync(IDalamudPluginInterface pluginInterface) {
        ...
        NotificationMaster = new(Svc.PluginInterface);
        BaitManager = new SeFunctions.BaitManager();
